						...
						<div class="col-md-10">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<button type="button" class="btn btn-default">khóa</button>
									<button type="button" class="btn btn-default">Bỏ Khóa</button>
									...
									<table class="table table-bordered table-hover">
										...
										<c:forEach var="rows" items="${result.rows }">
											<tr>
												...
												<td>${rows.Email }</td>
												<td>${rows.Quyen }</td>
												<td><a href="admin3.jsp" class="glyphicon glyphicon-pencil">edit</a></td>
											</tr>
										</c:forEach>
										</tbody>
									</table>
