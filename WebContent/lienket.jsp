							...
							<div class="panel panel-info">
								...
								<div class="panel-body">
									<form class="form-horizontal" role="form">
									  <div class="form-group">
									    <label class="col-sm-3">Web Trường:</label>
									    <div class="col-sm-9">
									      <a href="" class="form-control-static">hcmute.edu.vn</a>
									    </div>
									  </div>
									  ...
									  <div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <a href="" class="form-control-static">Online.hcmute.edu.vn</a>
									    </div>
									  </div>
									  <div class="form-group">
									    <label class="col-sm-3">DKMH:</label>
									    <div class="col-sm-9">
									      <a href="" class="form-control-static">dkmh.hcmute.edu.vn</a>
									    </div>
									  </div>
