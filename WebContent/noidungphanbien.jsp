					...
					<!--cột giữa-->
						<div class="col-md-10 ">
							<div class="panel panel-info	">
								<div class="panel-heading">
									<h3 class="panel-title">Phiếu Phản Biện</h3>
								</div>
								<div class="panel-body">
										...
										<!--cot trái-->
											<div class="col-md-8">
												...
												<form action="" class="form-horizontal">
													...
													<div class="form-group">
													    <label for="inputEmail3" class="col-sm-3 control-label">Tên người phản biện</label>
													    <div class="col-sm-9">
													      <p class="form-control-static">Mr.Tùng</p>
													    </div>
													  </div>

													<div class="form-group">
													    <label for="inputEmail3" class="col-sm-3 control-label">Bài phản biện</label>
													    <div class="col-sm-9">
													      <p class="form-control-static">Lập trình web nâng cao</p>
													    </div>
													  </div>
										...
										<div class="row">
											<div class="col-md-offset-4">
												...
												<a href="phanbien2.jsp"><button type="button" class="btn btn-warning">Hủy</button></a>
											</div>
