					...
					<!--cột giữa-->
						<div class="col-md-10">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Chỉnh Sử</h3>
								</div>
								<div class="panel-body">
									...
									<div class="form-group">
									 <label for="inputPassword3" class="col-sm-2 control-label">Quyền Truy Cập</label>
										...
										<button type="button" class="btn btn-primary col-md-offset-3">Lưu</button>
										<a href="admin2.jsp"><button type="button" class="btn btn-warning">Hủy</button></a>
								</div>
							</div>
